    ...
    function(t) {
      ...
      i(e, "Core/Axis/Color/ColorAxisComposition.js", [e["Core/Color/Color.js"], e["Core/Utilities.js"]], function(t2, e2) {
        ...
        return function(t3) {
          ...
          function p(t4) {
            t4.visible && t4.item.legendColor && t4.item.legendItem.symbol.attr({
              fill: t4.item.legendColor
            });
          }
          function d(t4) {
            this.chart.colorAxis?.forEach((e4) => {
              e4.update({}, t4.redraw);
            });
          }
          function c() {
          ...
          t3.compose = function(t4, s2, l2, y, x) {
            ...
            M.collectionsWithUpdate.includes("colorAxis") || (e3 = t4, M.collectionsWithUpdate.push("colorAxis"), M.collectionsWithInit.colorAxis = [M.addColorAxis], o(s2, "afterGetAxes", i3), function(t5) {
              ...
              t5.prototype.createAxis = function(t6, s3) {
                ...
                let o2 = new e3(this, a(s3.axis, {
                  index: this[t6].length,
                  isX: false
                }));
            ...
            }(s2), C.fillSetter = f, C.strokeSetter = b, o(y, "afterGetAllItems", h), o(y, "afterColorizeItem", p), o(y, "afterUpdate", d), r(j, {
              optionalAxis: "colorAxis",
              translateColors: g
            }), r(j.pointClass.prototype, {
              setVisible: m
            }), o(x, "afterTranslate", c, {
              order: 1
            }), o(x, "bindAxes", u));
        ...
        class y extends t2 {
          ...
          setOptions(t3) {
            let e3 = g(l.colorAxis, t3, {
              showEmpty: false,
              title: null,
              visible: this.chart.options.legend.enabled && false !== t3.visible
            });
            super.setOptions(e3), this.options.crosshair = this.options.marker;
          }
          setAxisSize() {
            let t3 = this.chart, e3 = this.legendItem?.symbol, {
              width: i3,
              height: s2
            } = this.getSize();
          ...
          getOffset() {
            let t3 = this.legendItem?.group, e3 = this.chart.axisOffset[this.side];
            if (t3) {
          ...
          drawLegendSymbol(t3, e3) {
            let i3 = e3.legendItem || {}, s2 = t3.padding, o2 = t3.options, r2 = this.options.labels, a2 = f(o2.itemDistance, 10), n2 = this.horiz, {
              width: l2,
              height: h2
            } = this.getSize(), p2 = f(o2.labelPadding, n2 ? 16 : 30);
            this.setLegendColor(), i3.symbol || (i3.symbol = this.chart.renderer.symbol("roundedRect").attr({
              r: o2.symbolRadius ?? 3,
              zIndex: 1
            }).add(i3.group)), i3.symbol.attr({
              x: 0,
              y: (t3.baseline || 0) - 11,
              width: l2,
              height: h2
            }), i3.labelWidth = l2 + s2 + (n2 ? a2 : f(r2.x, r2.distance) + (this.maxLabelLength || 0)), i3.labelHeight = h2 + s2 + (n2 ? p2 : 0);
          }
          setState(t3) {
          ...
          getDataClassLegendSymbols() {
            ...
            return s2.length || e3.dataClasses.forEach((o3, h2) => {
              let p2 = o3.from, u2 = o3.to, {
                numberFormatter: m2
              } = i3, g2 = true;
              t3 = "", void 0 === p2 ? t3 = "< " : void 0 === u2 && (t3 = "> "), void 0 !== p2 && (t3 += m2(p2, a2) + n2), void 0 !== p2 && void 0 !== u2 && (t3 += " - "), void 0 !== u2 && (t3 += m2(u2, a2) + n2), s2.push(d({
                chart: i3,
                name: t3,
                options: {},
          ...
          getSize() {
            ...
            return {
              width: f(p(s2) ? b(s2, t3.chartWidth) : void 0, o2?.symbolWidth, e3 ? y.defaultLegendLength : 12),
              height: f(p(i3) ? b(i3, t3.chartHeight) : void 0, o2?.symbolHeight, e3 ? 12 : y.defaultLegendLength)
            };
          }
        }
        ...
        return function(t3) {
          ...
          function h(t4, e4, i3) {
            ...
            if (e4 = t4.call(this, e4, i3), o2 && o2.mapView) {
              let t5 = o2.mapView.pixelsToLonLat({
                x: e4.chartX - o2.plotLeft,
                y: e4.chartY - o2.plotTop
              });
              t5 && s(e4, t5);
            }
            return e4;
          ...
          t3.compose = function(t4) {
            let e4 = t4.prototype;
            e4.onContainerDblClick || (s(e4, {
              onContainerDblClick: n,
              onContainerMouseWheel: l
            }), r(e4, "normalize", h), r(e4, "zoomOption", p));
          };
        }(e2 || (e2 = {})), e2;
        ...
        class g {
          ...
          update(t3) {
            ...
            if (!i3.renderer.forExport && c(r2.enableButtons, r2.enabled)) {
              e3.navButtonsGroup || (e3.navButtonsGroup = i3.renderer.g().attr({
                zIndex: 7
              }).add()), d(r2.buttons, (t5, a2) => {
                let n2 = {
                  padding: (t5 = p(r2.buttonOptions, t5)).padding
                };
                ...
                let {
                  ...
                  height: u2 = 0,
                  padding: g2 = 0
                } = t5, f = i3.renderer.button("+" !== d2 && "-" !== d2 && d2 || "", 0, 0, o2, n2, void 0, void 0, void 0, "zoomIn" === a2 ? "topbutton" : "bottombutton").addClass("highcharts-map-navigation highcharts-" + {
                  zoomIn: "zoom-in",
                  zoomOut: "zoom-out"
                }[a2]).attr({
                  width: c2,
                  height: u2,
                  title: i3.options.lang[a2],
                  zIndex: 5
                }).add(e3.navButtonsGroup);
                if ("+" === d2 || "-" === d2) {
                  let e4 = c2 + 1, s3 = [["M", g2 + 3, g2 + u2 / 2], ["L", g2 + e4 - 3, g2 + u2 / 2]];
                  "+" === d2 && s3.push(["M", g2 + e4 / 2, g2 + 3], ["L", g2 + e4 / 2, g2 + u2 - 3]), i3.renderer.path(s3).addClass("highcharts-button-symbol").attr(i3.styledMode ? {} : {
                    stroke: t5.style?.color,
                    "stroke-width": 3,
                    "stroke-linecap": "round"
                  }).add(f);
                }
                if (f.handler = t5.onclick, l(f.element, "dblclick", m), s2.push(f), h(t5, {
                  width: f.width,
                  height: 2 * (f.height || 0)
                }), i3.hasLoaded) f.align(t5, false, t5.alignTo);
                else {
                  let e4 = l(i3, "load", () => {
              ...
              i3.hasLoaded || l(i3, "render", function() {
                ...
                if (s3) {
                  ...
                  if (t4(s3, i4)) {
                    ...
                    e3.navButtonsGroup.attr({
                      translateY: "bottom" === a2 ? t5 : o3
                    });
                  }
                }
              });
        ...
        return function(t3) {
          function i3(t4) {
            ...
            this.moveToTopOnHover && this.graphic && (i4.stateMarkerGraphic || (i4.stateMarkerGraphic = new e2(s2, "use").css({
              pointerEvents: "none"
            }).add(this.graphic.parentGroup)), t4?.state === "hover" ? (this.graphic.attr({
              id: this.id
            }), i4.stateMarkerGraphic.attr({
              href: `${s2.url}#${this.id}`,
              visibility: "visible"
            })) : i4.stateMarkerGraphic.attr({
              href: ""
        ...
        class h extends t2 {
          init(t3, e3) {
            let i3 = r().credits, s2 = n({
              ...
              credits: {
                mapText: l(i3.mapText, ' © <a href="{geojson.copyrightUrl}">{geojson.copyrightShort}</a>'),
                mapTextFull: l(i3.mapTextFull, "{geojson.copyright}")
              },
              mapView: {},
              tooltip: {
          ...
          update(t3) {
            t3.chart && "map" in t3.chart && this.mapView?.recommendMapView(this, [t3.chart.map, ...(this.options.series || []).map((t4) => t4.mapData)], true), super.update.apply(this, arguments);
          }
        }
        ...
        let {
          boundsFromPath: o
        } = e2, r = i2.seriesTypes.scatter.prototype.pointClass, {
          extend: a,
          isNumber: n,
          pick: l
        } = s;
        class h extends r {
          ...
          applyOptions(t3, e3) {
            ...
            if (i3.mapData && i3.mapMap) {
              ...
              r2 ? a(s2, __spreadProps(__spreadValues({}, r2), {
                name: s2.name ?? r2.name
              })) : -1 !== i3.pointArrayMap.indexOf("value") && (s2.value = s2.value || null);
            }
            return s2;
          }
          ...
          zoomTo(t3) {
            ...
            if (i3 && s2) {
              ...
              if (o2) {
                let t4 = o2.projectedUnitsToPixels({
                  x: s2.x1,
                  y: s2.y1
                }), e4 = o2.projectedUnitsToPixels({
                  x: s2.x2,
                  y: s2.y2
                }), r2 = i3.pixelsToProjectedUnits({
                  x: t4.x,
                  y: t4.y
                }), a2 = i3.pixelsToProjectedUnits({
                  x: e4.x,
                  y: e4.y
                });
                s2 = {
        ...
        return a(h.prototype, {
          dataLabelOnNull: t2.pointMembers.dataLabelOnNull,
          moveToTopOnHover: t2.pointMembers.moveToTopOnHover,
          isValid: t2.pointMembers.isValid
        }), h;
        ...
        return function(t3) {
          ...
          function s2(t4, e4) {
            ...
            let {
              ...
              yoffset: d2 = 0,
              ypan: c2 = 0
            } = e4, u = i4(e4.crs, [t4.lon, t4.lat]), m = e4.cosAngle || e4.rotation && Math.cos(e4.rotation), g = e4.sinAngle || e4.rotation && Math.sin(e4.rotation), f = e4.rotation ? [u[0] * m + u[1] * g, -u[0] * g + u[1] * m] : u;
            return {
              x: ((f[0] - h2) * l2 + p2) * n2 + s3,
              y: -(((d2 - f[1]) * l2 + c2) * n2 - r2)
            };
          }
          function p(t4, e4) {
            let i4 = this.options.chart.proj4 || o.proj4;
            ...
            let {
              ...
              x: ((t4.x - s3) / n2 - p2) / l2 + h2,
              y: ((t4.y - r2) / n2 + c2) / l2 + d2
            }, m = e4.cosAngle || e4.rotation && Math.cos(e4.rotation), g = e4.sinAngle || e4.rotation && Math.sin(e4.rotation), f = i4(e4.crs, "WGS84", e4.rotation ? {
              x: u.x * m + -(u.y * g),
              y: u.x * g + u.y * m
            } : u);
            return {
          ...
          function d(t4, e4) {
            ...
            for (let t5 = 0, e5 = r2.length; t5 < e5; ++t5) a2.push({
              type: "Feature",
              properties: r2[t5].properties,
              geometry: {
                type: r2[t5].type,
                coordinates: r2[t5].coordinates || o2(r2[t5].arcs)
              }
            });
            let n2 = {
              type: "FeatureCollection",
              copyright: t4.copyright,
              copyrightShort: t4.copyrightShort,
              copyrightUrl: t4.copyrightUrl,
              features: a2,
              "hc-recommended-mapview": i4["hc-recommended-mapview"],
              bbox: t4.bbox,
              title: t4.title
            };
          ...
          function c(t4, e4) {
            e4 = l(true, this.options.credits, e4), t4.call(this, e4), this.credits && this.mapCreditsFull && this.credits.attr({
          ...
          t3.compose = function(t4) {
            ...
            for (let t5 = 0, i5 = a2.length; t5 < i5; ++t5) {
              ...
              if (("map" === e4 || "mapbubble" === e4) && ("Polygon" === l2 || "MultiPolygon" === l2) ? h2.length && (i6 = {
                geometry: {
                  coordinates: h2,
                  type: l2
                }
              }) : "mapline" === e4 && ("LineString" === l2 || "MultiLineString" === l2) ? h2.length && (i6 = {
                geometry: {
                  coordinates: h2,
                  type: l2
                }
              }) : "mappoint" === e4 && "Point" === l2 && h2.length && (i6 = {
                geometry: {
                  coordinates: h2,
                  type: l2
                }
                ...
                s3.push(n(i6, {
                  lat: "number" == typeof o4 ? o4 : void 0,
                  lon: "number" == typeof e5 ? e5 : void 0,
                  name: "string" == typeof t6 ? t6 : void 0,
                  properties: p2
                }));
              }
            }
            return i4 && o2.copyrightShort && (i4.chart.mapCredits = r(i4.chart.options.credits?.mapText, {
              geojson: o2
            }), i4.chart.mapCreditsFull = r(i4.chart.options.credits?.mapTextFull, {
              geojson: o2
            })), s3;
          }, t3.topo2geo = d;
        }(s || (s = {})), s;
        ...
        return class {
          ...
          inverse(s2) {
            let {
              c: o,
              n: r
            } = this, a = s2[0] / 63.78137, n = o - s2[1] / 63.78137, l = t2(r) * Math.sqrt(a * a + n * n), h = Math.atan2(a, Math.abs(n)) * t2(n);
        ...
        let {
          ...
          clamp: r,
          erase: a
        } = i2, n = 2 * Math.PI / 360, l = (t3) => (t3 < -180 && (t3 += 360), t3 > 180 && (t3 -= 360), t3), h = (t3) => (1 - Math.cos(t3)) / 2, p = (t3, e3) => {
        ...
        class d {
          ...
          static geodesic(t3, e3, i3, s2 = 5e5) {
            let {
              ...
              sin: a2,
              sqrt: l2
            } = Math, h2 = d.distance, p2 = t3[1] * n, c = t3[0] * n, u = e3[1] * n, m = e3[0] * n, g = r2(p2) * r2(c), f = r2(u) * r2(m), b = r2(p2) * a2(c), y = r2(u) * a2(m), x = a2(p2), M = a2(u), C = h2(t3, e3), j = C / 6371e3, v = a2(j), w = Math.round(C / s2), S = [];
            if (i3 && S.push(t3), w > 1) {
              let t4 = 1 / w;
              ...
              if (e3) {
                ...
                if (i3) for (let t4 = 0; t4 < o2.length; t4++) {
                  let {
                    direction: e5,
                    lat: s3
                  } = i3, r2 = o2[t4], a2 = r2.indexOf(i3.lonLat);
                  if (a2 > -1) {
          ...
          path(t3) {
            ...
            let {
              ...
              def: r2,
              rotator: a2
            } = this, n2 = [], l2 = "Polygon" === t3.type || "MultiPolygon" === t3.type, h2 = this.hasGeoProjection, p2 = !r2 || false !== r2.antimeridianCutting, c = p2 ? a2 : void 0, u = p2 && r2 || this;
        ...
        function S(t3) {
          t3.seriesOptions.mapData && this.mapView?.recommendMapView(this, [this.options.chart.map, t3.seriesOptions.mapData], this.options.drilldown?.mapZooming);
        }
        class P {
          static compose(t3) {
            C(n, "MapView") && (v = t3.maps, d(t3, "afterInit", function() {
              ...
              order: 0
            }), d(t3, "addSeriesAsDrilldown", S), d(t3, "afterDrillUp", S));
          }
          ...
          constructor(t3, i3) {
            ...
            let s2 = x(e2, this.recommendedMapView, i3), o2 = this.recommendedMapView?.insets, a2 = i3 && i3.insets;
          ...
          getField(t3 = true) {
            ...
            return {
              x: e3[3],
              y: e3[0],
              width: this.chart.plotWidth - e3[1] - e3[3],
              height: this.chart.plotHeight - e3[0] - e3[2]
            };
          }
          getGeoMap(t3) {
          ...
          getMapBBox() {
            ...
            if (t3) {
              let i3 = this.padding, s2 = this.projectedUnitsToPixels({
                x: t3.x1,
                y: t3.y2
              });
              return {
                width: (t3.x2 - t3.x1) * e3 + i3[1] + i3[3],
                height: (t3.y2 - t3.y1) * e3 + i3[0] + i3[2],
                x: s2.x - i3[3],
                y: s2.y - i3[0]
              };
            }
              ...
              if (!this.fitToGeometryCache) {
                if ("MultiPoint" === i3.type) {
                  ...
                  this.fitToGeometryCache = {
                    x1: Math.min.apply(0, s2),
                    x2: Math.max.apply(0, s2),
                    y1: Math.min.apply(0, o2),
                    y2: Math.max.apply(0, o2)
                  };
          ...
          getSVGTransform() {
            let {
              ...
              width: i3,
              height: s2
            } = this.playingField, o2 = this.projection.forward(this.center), r2 = this.projection.hasCoordinates ? -1 : 1, a2 = this.getScale(), n2 = a2 * r2, l2 = t3 + i3 / 2 - o2[0] * a2, h2 = e3 + s2 / 2 - o2[1] * n2;
            return {
              scaleX: a2,
              scaleY: n2,
              translateX: l2,
          ...
          lonLatToProjectedUnits(t3) {
            ...
            for (let e4 of this.insets) if (e4.options.geoBounds && l({
              x: t3.lon,
              y: t3.lat
            }, e4.options.geoBounds.coordinates[0])) {
              let i4 = e4.projection.forward([t3.lon, t3.lat]), s3 = e4.projectedUnitsToPixels({
                x: i4[0],
                y: i4[1]
              });
          ...
          recommendMapView(t3, e3, i3 = false) {
            ...
            m(this, "onRecommendMapView", {
              ...
              if (r2 && this.recommendedMapView) {
                if (!this.recommendedMapView.projection) {
                  ...
                  this.recommendedMapView.projection = i4 - t4 > 180 && s3 - e4 > 90 ? {
                    name: "EqualEarth",
                    parallels: [0, 0],
                    rotation: [0]
                  } : {
            ...
            }), this.geoMap = s2[0], i3 && t3.hasRendered && !t3.userOptions.mapView?.projection && this.recommendedMapView && this.update(this.recommendedMapView);
          }
          redraw(t3) {
          ...
          setView(t3, e3, i3 = true, s2) {
            ...
            if (o2) {
              let t4 = this.projection.forward(this.center), {
                x: e4,
                y: i4,
                width: s3,
                height: r2
              } = this.playingField, a2 = this.getScale(), n2 = this.projectedUnitsToPixels({
                x: o2.x1,
                y: o2.y1
              }), l2 = this.projectedUnitsToPixels({
                x: o2.x2,
                y: o2.y2
              }), h2 = [(o2.x1 + o2.x2) / 2, (o2.y1 + o2.y2) / 2];
          ...
          pixelsToProjectedUnits(t3) {
            let {
              x: e3,
              y: i3
            } = t3, s2 = this.getScale(), o2 = this.projection.forward(this.center), r2 = this.playingField, a2 = r2.x + r2.width / 2, n2 = r2.y + r2.height / 2;
            return {
              x: o2[0] + (e3 - a2) / s2,
              y: o2[1] - (i3 - n2) / s2
            };
          ...
          setUpEvents() {
            ...
            let {
              ...
              let {
                lastTouches: r2,
                pinchDown: a2
              } = s2.pointer, n2 = this.projection, l2 = o3.touches, {
                mouseDownX: h2,
                mouseDownY: p2
              } = s2, d2 = 0;
              if (a2?.length === 1 ? (h2 = a2[0].chartX, p2 = a2[0].chartY) : a2?.length === 2 && (h2 = (a2[0].chartX + a2[1].chartX) / 2, p2 = (a2[0].chartY + a2[1].chartY) / 2), l2?.length === 2 && r2 && (d2 = Math.log(Math.sqrt(Math.pow(r2[0].chartX - r2[1].chartX, 2) + Math.pow(r2[0].chartY - r2[1].chartY, 2)) / Math.sqrt(Math.pow(l2[0].chartX - l2[1].chartX, 2) + Math.pow(l2[0].chartY - l2[1].chartY, 2))) / Math.log(0.5)), f(h2) && f(p2)) {
                let r3 = `${h2},${p2}`, {
                  chartX: a3,
                  chartY: u2
                } = o3.originalEvent;
                l2?.length === 2 && (a3 = (l2[0].chartX + l2[1].chartX) / 2, u2 = (l2[0].chartY + l2[1].chartY) / 2), r3 !== e3 && (e3 = r3, t3 = this.projection.forward(this.center), i3 = (this.projection.options.rotation || [0, 0]).slice());
                let m2 = n2.def && n2.def.bounds, g2 = m2 && w(m2, this.playingField) || -1 / 0;
                if ("Orthographic" === n2.options.name && 2 > (l2?.length || 0) && (this.minZoom || 1 / 0) < 1.3 * g2) {
                  ...
                  if (i3) {
                    ...
                    }, false), this.fitToBounds(void 0, void 0, false), this.zoom = r4, s2.redraw(false);
                  }
                } else if (f(a3) && f(u2)) {
            ...
            d(s2, "pan", o2), d(s2, "touchpan", o2), d(s2, "selection", (t4) => {
              if (t4.resetSelection) this.zoomBy();
                ...
                let e4 = t4.x - s2.plotLeft, i4 = t4.y - s2.plotTop, {
                  y: o3,
                  x: r2
                ...
                this.fitToBounds({
                  ...
                  x2: n2,
                  y2: a2
                }, void 0, true, !t4.originalEvent.touches && void 0), /^touch/.test(t4.originalEvent.type) || s2.showResetZoom(), t4.preventDefault();
              }
            });
          }
          render() {
        ...
        class L extends P {
          constructor(t3, e3) {
            if (super(t3.chart, e3), this.id = e3.id, this.mapView = t3, this.options = x({
              center: [0, 0]
            }, t3.options.insetOptions, e3), this.allBounds = [], this.options.geoBounds) {
          ...
          getHitZone() {
            ...
            if (s2) {
              let o2 = s2[0];
              if ("percent" === i3.units) {
                let s3 = "mapBoundingBox" === i3.relativeTo && e3.getMapBBox() || x(t3.plotBox, {
                  x: 0,
                  y: 0
                });
          ...
          isInside(t3) {
            let {
              geoBoundsProjectedBox: e3,
              geoBoundsProjectedPolygon: i3
            } = this;
          ...
          render() {
            let {
              ...
              mapView: e3,
              options: i3
            } = this, s2 = i3.borderPath || i3.field;
            if (s2 && e3.group) {
              let o2 = true;
              this.border || (this.border = t3.renderer.path().addClass("highcharts-mapview-inset-border").add(e3.group), o2 = false), t3.styledMode || this.border.attr({
                stroke: i3.borderColor,
                "stroke-width": i3.borderWidth
              });
        ...
        class A extends g {
          ...
          animate(t3) {
            let {
              chart: e3,
              group: i3
            } = this, s2 = p(this.options.animation);
            t3 ? i3.attr({
              translateX: e3.plotLeft + e3.plotWidth / 2,
              translateY: e3.plotTop + e3.plotHeight / 2,
              scaleX: 1e-3,
              scaleY: 1e-3
            }) : i3.animate({
              translateX: e3.plotLeft,
              translateY: e3.plotTop,
              scaleX: 1,
              scaleY: 1
            }, s2);
          }
            ...
            if (o2) {
              ...
              this.doFullTranslate() && (this.points.forEach((t4) => {
                ...
                if (s3) {
                  ...
                  i4.name && (r3 += "highcharts-name-" + i4.name.replace(/ /g, "-").toLowerCase()), i4.properties && i4.properties["hc-key"] && (r3 += " highcharts-key-" + i4.properties["hc-key"].toString().toLowerCase()), r3 && s3.addClass(r3), e3.styledMode && s3.css(this.pointAttribs(i4, i4.selected && "select" || void 0)), s3.attr({
                    visibility: !i4.visible && (i4.visible || i4.isNull) ? "hidden" : "inherit"
                  }), s3.animate = function(i5, r4, a2) {
                ...
                let a2 = (0 === s3 ? o2 : o2.insets[s3 - 1]).getSVGTransform(), n2 = P(this.getStrokeWidth(this.options), 1), l2 = a2.scaleX, h2 = a2.scaleY > 0 ? 1 : -1, c2 = (e4) => {
                  (t3.points || []).forEach((t4) => {
                    let i5;
                    let s4 = t4.graphic;
                    s4 && s4["stroke-width"] && (i5 = this.getStrokeWidth(t4.options)) && s4.attr({
                      "stroke-width": i5 / e4
                    });
                  });
                };
                if (r2.globalAnimation && e3.hasRendered && o2.allowTransformAnimation) {
                  let t4 = Number(i4.attr("translateX")), e4 = Number(i4.attr("translateY")), s4 = Number(i4.attr("scaleX")), o3 = (o4, r3) => {
                    ...
                    i4.attr({
                      translateX: t4 + (a2.translateX - t4) * r3.pos,
                      translateY: e4 + (a2.translateY - e4) * r3.pos,
                      scaleX: p2,
                      scaleY: p2 * h2,
                      "stroke-width": n2 / p2
                    }), c2(p2);
                  ...
                  d2.step = function() {
                    ...
                    "boolean" != typeof r2.globalAnimation && r2.globalAnimation.complete && r2.globalAnimation.complete({
                      applyDrilldown: true
                    }), y(this, "mapZoomComplete");
                  }).bind(this));
                } else d(i4), i4.attr(w(a2, {
                  "stroke-width": n2 / l2
                })), c2(l2);
          ...
          pointAttribs(t3, e3) {
            let {
              mapView: i3,
              styledMode: s2
            } = t3.series.chart, o2 = s2 ? this.colorAttribs(t3) : m.prototype.pointAttribs.call(this, t3, e3), r2 = this.getStrokeWidth(t3.options);
            if (e3) {
          ...
          processData() {
            ...
            if (i3) {
              ...
              if (o2.allAreas) {
                ...
                i3.forEach((e4) => {
                  h2[0] && -1 !== t4.indexOf("|" + e4[h2[0]] + "|") || f2.push(w(e4, {
                    value: null
                  }));
                });
              }
          ...
          translate() {
            ...
            if (this.chart.hasRendered && (this.isDirtyData || !this.hasRendered) && (this.processData(), this.generatePoints(), delete this.bounds, !e3 || e3.userOptions.center || j(e3.userOptions.zoom) || e3.zoom !== e3.minZoom ? this.getProjectedBounds() : e3.fitToBounds(void 0, void 0, false)), e3) {
              ...
              this.points.forEach((o2) => {
                ...
                a2 && o2.bounds && j(o2.bounds.midX) && j(o2.bounds.midY) && (o2.plotX = o2.bounds.midX * a2.scaleX + a2.translateX, o2.plotY = o2.bounds.midY * a2.scaleY + a2.translateY), t3 && (o2.shapeType = "path", o2.shapeArgs = {
                  d: r.getProjectedPath(o2, i3)
                }), o2.hiddenInDataClass || (o2.projectedPath && !o2.projectedPath.length ? o2.setVisible(false) : o2.visible || o2.setVisible(true));
              });
            }
            y(this, "afterTranslate");
          }
          update(t3) {
            t3.mapData && this.chart.mapView?.recommendMapView(this.chart, [this.chart.options.chart.map, ...(this.chart.options.series || []).map((e3, i3) => i3 === this._i ? t3.mapData : e3.mapData)], true), super.update.apply(this, arguments);
          }
        }
        return A.defaultOptions = w(g.defaultOptions, a), f(A.prototype, {
          type: "map",
          axisTypes: e2.seriesMembers.axisTypes,
          colorAttribs: e2.seriesMembers.colorAttribs,
          colorKey: e2.seriesMembers.colorKey,
          directTouch: true,
          drawDataLabels: c,
          drawGraph: c,
          forceDL: true,
          getCenter: i2.getCenter,
          getExtremesFromAll: true,
          getSymbol: c,
          isCartesian: false,
          parallelArrays: e2.seriesMembers.parallelArrays,
          pointArrayMap: e2.seriesMembers.pointArrayMap,
          pointClass: r,
          preserveAspectRatio: true,
          searchPoint: c,
          trackerGroups: e2.seriesMembers.trackerGroups,
          useMapGeometry: true
        }), e2.compose(A), l.registerSeriesType("map", A), A;
        ...
        return a.defaultOptions = r(e2.defaultOptions, t2), o(a.prototype, {
          type: "mapline",
          colorProp: "stroke",
          pointAttrToOptions: {
            stroke: "color",
        ...
        }), i2.registerSeriesType("mapline", a), a;
          ...
          projectPoint(t3) {
            ...
            if (e3) {
              let {
                ...
                lon: s2,
                lat: o2
              } = t3, r2 = i3 && "Point" === i3.type && i3.coordinates;
              if (d(s2) && d(o2) && (r2 = [s2, o2]), r2) return e3.lonLatToProjectedUnits({
                lon: r2[0],
                lat: r2[1]
              });
            }
            ...
            if (this.processedXData || this.processData(), this.generatePoints(), this.getProjectedBounds && this.isDirtyData && (delete this.bounds, this.getProjectedBounds()), t3) {
              ...
              this.points.forEach((s2) => {
                let o2, {
                  x: r2,
                  y: a2
                } = s2, n2 = d(s2.insetIndex) && t3.insets[s2.insetIndex].getSVGTransform() || e3, l2 = this.projectPoint(s2.options) || s2.properties && this.projectPoint(s2.properties);
                if (l2 ? (r2 = l2.x, a2 = l2.y) : s2.bounds && (r2 = s2.bounds.midX, a2 = s2.bounds.midY, n2 && d(r2) && d(a2) && (s2.plotX = r2 * n2.scaleX + n2.translateX, s2.plotY = a2 * n2.scaleY + n2.translateY, o2 = true)), d(r2) && d(a2)) {
                  if (!o2) {
                    let e4 = t3.projectedUnitsToPixels({
                      x: r2,
                      y: a2
                    });
        ...
        return class {
          ...
          setOptions() {
            let t3 = this.ranges, e3 = this.options, i3 = this.chart.series[e3.seriesIndex], s2 = this.legend.baseline, r2 = {
              zIndex: e3.zIndex,
            ...
            t3.forEach(function(c, u) {
              d2 || (r2.stroke = p(c.borderColor, e3.borderColor, i3.color), r2.fill = p(c.color, e3.color, 1 !== l2 ? o(i3.color).setOpacity(l2).get("rgba") : i3.color), a2.stroke = p(c.connectorColor, e3.connectorColor, i3.color)), t3[u].radius = this.getRangeRadius(c.value), t3[u] = h(t3[u], {
                center: t3[0].radius - t3[u].radius + s2
              }), d2 || h(true, t3[u], {
                bubbleAttribs: h(r2),
                connectorAttribs: h(a2),
                labelAttribs: n2
              });
            }, this);
          }
          ...
          renderRange(t3) {
            ...
            let j = n2.text(this.formatLabel(t3)).attr(M ? {} : t3.labelAttribs).css(M ? {} : o2.style).addClass("highcharts-bubble-legend-labels " + (s2.labels.className || "")).add(this.legendItem.symbol), v = {
              x: b + C + s2.labels.x,
              y: y + s2.labels.y + 0.4 * j.getBBox().height
            };
        ...
        function f(t3, e3) {
          ...
          i3.forEach((t4, i4) => {
            (n2 = t4.legendItem || {}).group && (o2 = n2.group.translateX || 0, r2 = n2.y || 0, ((a2 = t4.movementX) || s2 && t4.ranges) && (a2 = s2 ? o2 - t4.options.maxSize / 2 : o2 + a2, n2.group.attr({
              translateX: a2
            })), i4 > e3[l2].step && l2++, n2.group.attr({
              translateY: Math.round(r2 + e3[l2].height / 2)
            }), n2.y = r2 + e3[l2].height / 2);
          });
        }
        return {
          compose: function(e3, i3) {
            ...
            }), p(e3.prototype, "drawChartBox", d), n(i3, "afterGetAllItems", m), n(i3, "itemClick", g));
          }
        };
        ...
        function C() {
          let t3 = this.len, {
            ...
            isXAxis: i3,
            min: s2
          } = this, o2 = i3 ? "xData" : "yData", r2 = (this.max || 0) - (s2 || 0), a2 = 0, n2 = t3, l2 = t3 / r2, h2;
        ...
        class j extends d {
          ...
          getRadii() {
            let t3 = this.zData, e3 = this.yData, i3 = [], s2, o2, r2, a2 = this.chart.bubbleZExtremes, {
              minPxSize: n2,
              maxPxSize: l2
            } = this.getPxExtremes();
            if (!a2) {
              ...
              this.chart.series.forEach((s3) => {
                ...
                zMin: e4,
                zMax: i4
              }, this.chart.bubbleZExtremes = a2) : a2 = {
                zMin: 0,
                zMax: 0
              };
            }
          ...
          markerAttribs(t3, e3) {
            ...
            return this.chart.inverted ? f(i3, {
              x: (t3.plotX || 0) - o2 / 2,
              y: (t3.plotY || 0) - s2 / 2
            }) : i3;
          }
          ...
          translateBubble() {
            ...
            for (; o2--; ) {
              ...
              "z" === this.zoneAxis && (r2.negative = (r2.z || 0) < (e3.zThreshold || 0)), b(a2) && a2 >= s2 / 2 ? (r2.marker = f(r2.marker, {
                radius: a2,
                width: 2 * a2,
                height: 2 * a2
              }), r2.dlBox = {
                ...
                width: 2 * a2,
                height: 2 * a2
              }) : (r2.shapeArgs = r2.plotY = r2.dlBox = void 0, r2.isInside = false);
            }
          }
          getPxExtremes() {
        ...
        return j.defaultOptions = y(d.defaultOptions, {
          dataLabels: {
            formatter: function() {
              let {
                numberFormatter: t3
        ...
        class l extends t2 {
          ...
          searchPoint(t3, e3) {
            return this.searchKDTree({
              plotX: t3.chartX - this.chart.plotLeft,
              plotY: t3.chartY - this.chart.plotTop
            }, e3, t3);
          }
          translate() {
        ...
        return l.defaultOptions = n(t2.defaultOptions, {
          lineWidth: 0,
          animationLimit: 500,
          joinBy: "hc-key",
          tooltip: {
          ...
          useMapGeometry: true,
          xyFromShape: true
        }), i2.registerSeriesType("mapbubble", l), l;
        ...
        class n extends i2 {
          ...
          getCellAttributes() {
            let t3 = this.series, e3 = t3.options, i3 = (e3.colsize || 1) / 2, r2 = (e3.rowsize || 1) / 2, n2 = t3.xAxis, l = t3.yAxis, h = this.options.marker || t3.options.marker, p = t3.pointPlacementToXValue(), d = a(this.pointPadding, e3.pointPadding, 0), c = {
              x1: s(Math.round(n2.len - n2.translate(this.x - i3, false, true, false, true, -p)), -n2.len, 2 * n2.len),
              x2: s(Math.round(n2.len - n2.translate(this.x + i3, false, true, false, true, -p)), -n2.len, 2 * n2.len),
              y1: s(Math.round(l.translate(this.y - r2, false, true, false, true)), -l.len, 2 * l.len),
              y2: s(Math.round(l.translate(this.y + r2, false, true, false, true)), -l.len, 2 * l.len)
            };
        ...
        return {
          ...
          getContext: function(t3) {
            ...
            return e3 && s2 ? (s2.clearRect(0, 0, e3.width, e3.height), s2) : (t3.canvas = i2.createElement("canvas"), t3.context = t3.canvas.getContext("2d", {
        ...
        class M extends p {
          ...
          drawPoints() {
            ...
            if (i3) {
              ...
              if (!e4 || t3.isDirtyData || t3.isDirtyCanvas) {
                ...
                } = t3, m2 = i4.colorAxis && i4.colorAxis[0];
                if (l3 && a3 && m2) {
                  let {
                    min: m3,
                    max: g2
                    ...
                    min: f2,
                    max: b2
                  } = o2.getExtremes(), x2 = g2 - m3, M2 = b2 - f2, C = Math.round(x2 / p2 / 8 * 8), j = Math.round(M2 / d2 / 8 * 8), [v, w] = [[C, C / x2, r2, "ceil"], [j, j / M2, !n2, "floor"]].map(([t4, e5, i5, s4]) => i5 ? (i6) => Math[s4](t4 - e5 * i6) : (t5) => Math[s4](e5 * t5)), S = l3.width = C + 1, P = S * (l3.height = j + 1), L = (u2 - 1) / P, A = new Uint8ClampedArray(4 * P), T = (t4, e5) => 4 * Math.ceil(S * w(e5 - f2) + v(t4 - m3));
                  t3.buildKDTree();
                  for (let t4 = 0; t4 < P; t4++) {
                    let e5 = c2[Math.ceil(L * t4)], {
                      x: i5,
                      y: s4
                    } = e5;
                    A.set(y(e5.value, e5), T(i5, s4));
                  }
                  a3.putImageData(new ImageData(A, S), 0, 0), e4 ? e4.attr(__spreadProps(__spreadValues({}, h2), {
                    href: l3.toDataURL("image/png", 1)
                  })) : (t3.directTouch = false, t3.image = i4.renderer.image(l3.toDataURL("image/png", 1)).attr(h2).add(t3.group));
                }
          ...
          markerAttribs(t3, e3) {
            ...
            if (e3 && "normal" !== e3) {
              ...
              return {
                x: (i3.x || 0) + ((i3.width || 0) - n2) / 2,
                y: (i3.y || 0) + ((i3.height || 0) - l2) / 2,
                width: n2,
                height: l2
              };
            }
          ...
          translate() {
            let {
              borderRadius: t3,
              marker: e3
            } = this.options, i3 = e3 && e3.symbol || "rect", s2 = d[i3] ? i3 : "rect", o2 = -1 !== ["circle", "square"].indexOf(s2);
            ...
            for (let e4 of (this.generatePoints(), this.points)) {
              ...
              e4.hasImage && (e4.marker = {
                width: l2,
                height: h2
              }), e4.plotX = e4.clientX = (r2.x1 + r2.x2) / 2, e4.plotY = (r2.y1 + r2.y2) / 2, e4.shapeType = "path", e4.shapeArgs = f(true, {
                x: a2,
                y: n2,
                width: l2,
                height: h2
        ...
        }), e2.compose(M), o.registerSeriesType("heatmap", M), M;
